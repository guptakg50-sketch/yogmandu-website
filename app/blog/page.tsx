...
export const metadata: Metadata = {
  title: "Blog — Yoga, Sound Healing & Nepal | Yogmandu",
  description:
    "Insights on yoga philosophy, pranayama, sound healing, and life in Kathmandu. Written by the teachers at Yogmandu.",
};
